...
> Kurzindex. Alle Story-Details stehen gesammelt und numerisch sortiert in „📦 BACKLOG DETAILS" weiter unten.
...
_(aktuell keine Story in Bearbeitung)_
...
- US-008 – Cache-Strategie & Refresh-Zyklus (Datenzyklus-Optimierung)
...
Alle Stories in numerischer Reihenfolge (TODO und DONE gemeinsam, siehe Status-Feld je Story).
...
**Hinweis:** Diese Story wird an mehreren Stellen im Backlog als „US-008“ referenziert (z. B. bei US-013, US-015, US-016). Der folgende Copilot-Prompt ist die ursprüngliche fachliche Grundlage dafür.
